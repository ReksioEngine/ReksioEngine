...
export default class ReksioIFExpressionParser extends Parser {
    ...
    constructor(input: TokenStream) {
        ...
        this._interp = new ParserATNSimulator(
            this,
            ReksioIFExpressionParser._ATN,
            ReksioIFExpressionParser.DecisionsToDFA,
    ...
    public logicOperator(): LogicOperatorContext {
        const localctx: LogicOperatorContext = new LogicOperatorContext(this, this._ctx, this.state)
    ...
    static DecisionsToDFA = ReksioIFExpressionParser._ATN.decisionToState.map(
